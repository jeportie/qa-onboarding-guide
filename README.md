...
This guide is your single reference for everything you need to become an effective QA Automation Engineer on Ledger Live. It covers the full stack — from the monorepo architecture and device emulation to E2E test writing, CI/CD pipelines, and the 21 technologies that power it all.

Every chapter builds on the previous one. Each ends with an interactive quiz (80% to pass). Take your time with Parts 1-3 before jumping into the more advanced material.
