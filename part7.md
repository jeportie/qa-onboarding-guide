...
# PART 7 -- LEDGER WALLET COMPONENTS & SWAP LIVE APP
...
### 42.3 Architecture -- How a Live App Loads
...
### 42.6 Live Apps in the Ledger Wallet Catalog
...
### 42.7 QA Implications of the Live App Model
...
### 43.3 Frontend: the `swap-live-app` Repo
...
### 43.4 Backend: the `swap` Service and Completer
...
### 43.5 Configuration: the `swap-configuration` Repo
...
### 43.6 Shared Contracts: `exchange-sdk`
...
### 43.7 Static Assets: `ledger-live-assets`
...
### 43.9 The Regulatory Boundary (MiCA / CASP)
...
### 44.1 Release Model -- Trunk-Based on `develop`
...
### 44.2 The Environments and Their URLs
...
### 44.4 Feature Flags -- Where to Look
...
### 44.5 The Release Workflow in Practice
...
### 44.6 Monitoring and Observability
...
### 44.7 What Changes Across Environments -- Cheat Sheet
...
### 45.3 Analyzing Current Coverage
...
### 45.4 Picking the Representative Case
...
### 45.6 Run the Existing Swap Suite in Isolation to Confirm the Baseline
...
### 45.11 Open the PR with `/create-pr`, Mark Ready, and Link Xray
...
### 45.12 Reference -- Applying the Same Fix to the Other Missing Pairs
...
### 45.13 Reference -- Writing a Swap Test from Scratch
