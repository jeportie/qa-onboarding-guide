...
### 7.1.1 The Testing Pyramid at Ledger
...
### 7.1.3 Page Object Best Practices
...
### 7.2.3 Playwright Debugging Tools
...
### 7.2.7 LLD Debugging Tips (from the wiki)
...
### 7.3.1 CI at Ledger Live — GitHub Actions Anatomy
...
### 7.3.6 Mobile Sharding Deep Dive
...
### 7.3.7 Environment Variable Flow
...
### 7.3.9 Smoke vs Full, Production vs Staging Firebase
...
### 7.3.10 Kicking Off a Custom Run with `gh workflow run`
...
### 7.3.12 ASCII Sequence Diagrams
...
### 7.4.1 Claude Code in the Ledger Live Repository
...
### 7.4.3 The Socratic Decision Rule (Rodin)
...
### 7.4.4 Cursor IDE in the Ledger Live Repository
...
### 7.4.8 Using AI Tools for QA Tasks
...
You have reached the end of the guide. Part 6 covered the disciplines that separate a competent E2E contributor from a senior one. Chapter 7.1 taught test strategy — the pyramid, page object discipline, data-driven patterns, and flaky test management. Chapter 7.2 walked you through debugging failures across desktop (Playwright Inspector, Trace Viewer, Allure) and mobile (Detox verbose logs, `adb logcat`, synchronization bypass), plus Speculos troubleshooting. Chapter 7.3 unpacked CI/CD anatomy, the `@Gate` job, composite actions, and the shard matrix algorithm. Chapter 7.4 introduced the AI tooling around the repo — Claude Code, Cursor agents, and the Socratic Decision Rule (Rodin) that keeps planning honest.
